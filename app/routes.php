...
Route::post('addCredit', 'PaypalController@create');
Route::get('addCredit/confirm', 'PaypalController@getConfirmPayment');
Route::get('addCredit/cancel', 'PaypalController@getCancelPayment');
