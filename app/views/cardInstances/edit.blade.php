...
{{ Form::model($cardInstance, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('cardInstances.update', $cardInstance->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('cardInstances.show', 'Cancel', $cardInstance->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
